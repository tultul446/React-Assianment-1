...
function EmailList() {
  ...
  return (
    <section className='h-screen bg-cover bg-center items-center text-center  lg:space-y-10 py-5  max-w-auto text-white max-w-auto' style={{ backgroundImage:"url(./BG.png)"}}>
