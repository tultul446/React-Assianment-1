...
function Hero() {
  return (
    <section className='h-screen bg-cover bg-center flex items-center grid lg:grid-cols-2 md:grid-cols-2 sm:grid-row  mt-10 lg:space-y-10 p-5 ' style={{ backgroundImage:"url(./Img.png)"}} >
